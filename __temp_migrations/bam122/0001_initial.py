    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AC_Q1', otree.db.models.StringField(blank=0, choices=[('Very Exogenous', 'Very Exogenous'), ('Exogenous', 'Exogenous'), ('Slightly Exogenous', 'Slightly Exogenous'), ('Average/Neutral', 'Average/Neutral'), ('Slightly Endogenous', 'Slightly Endogenous'), ('Endogenous', 'Endogenous'), ('Very Endogenous', 'Very Endogenous')], max_length=10000, null=True, verbose_name='Exogenous')),
